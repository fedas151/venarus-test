...
if (document.querySelector(".slider-button-next")) {
    document.addEventListener("click", function (e) {
        if (e.target.closest('.slider-button-next')) {
            ...
            if (state === 1) {
                document.documentElement.classList.remove("third-state"),
                document.documentElement.classList.remove("second-state"),
                document.documentElement.classList.toggle("first-state");
            }
            else if (state === 2) {
                document.documentElement.classList.remove("third-state"),
                document.documentElement.classList.remove("first-state"),
                document.documentElement.classList.toggle("second-state");
            }
            else if (state === 3) {
                document.documentElement.classList.remove("first-state"),
                document.documentElement.classList.remove("second-state"),
                document.documentElement.classList.toggle("third-state");
            }
...
if (document.querySelector(".disclaimer__button")) {
    document.addEventListener("click", function (e) {
        if (e.target.closest('.disclaimer__button')) {
            document.documentElement.classList.toggle("disclaimer-closed");
        }
    });
};
